...
if (isset($_POST['submit'])) {
    ...
    move_uploaded_file($_FILES['image']['tmp_name'], "blog-image/$image");
    ...
    if (isset($_GET['u_id'])) {
        ...
        mysqli_query($conn, "insert into blog(name,amount,image,date) values('$name','$amount','$image','$date')");
        header("location:add-Blog.php");
    }
}
?>
                        ...
                        <form class="form" method="post" enctype="multipart/form-data">
                            <div class="form-body">
                                ...
                                <div class="form-group mt-2">
                                    ...
                                    <input type="text" name="date" id="donationinput3" class="form-control"
                                        placeholder="Date.." required value="<?php echo @$u_data['name']; ?>">
                                </div>
